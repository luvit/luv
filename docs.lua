...
local function async_cb(args)
  args = args or { { 'success', opt('boolean') } }
...
local types = {
  ...
  ['socket.type'] = union("'stream'", "'dgram'", "'raw'", "'rdm'", "'seqpacket'"),
      ...
      },
      {
        ...
        methods = {
          ...
          },
          {
            ...
            params = {
              { name = 'mode', type = opt('string'), default = '"default"' },
            },
      ...
      },
      {
        ...
        methods = {
          ...
          },
          {
            ...
            params = {
              { name = 'handle', type = 'uv_handle_t' },
              { name = 'size', type = opt('integer'), default = '0' },
            },
        ...
        methods = {
          ...
          },
          {
            ...
            params = {
              ...
              { name = 'events', type = opt('string'), default = '"rw"' },
              {
                name = 'callback',
                type = fun({
                  { 'err', opt('string') },
        ...
        methods = {
          {
            ...
            params = {
              { name = 'ipc', type = opt('boolean'), default = 'false' },
            },
        ...
        methods = {
          ...
          },
          {
            ...
            params = {
              ...
              { name = 'interface_addr', type = opt('string') },
          ...
          },
          {
            ...
            params = {
              ...
              { name = 'path', type = 'string' },
              {
                name = 'flags',
                type = table({
                  { 'watch_entry', opt('boolean'), 'false' },
                  { 'stat', opt('boolean'), 'false' },
                  { 'recursive', opt('boolean'), 'false' },
                }),
              },
              cb_err({
                { 'filename', 'string' },
                { 'events', table({ { 'change', opt('boolean') }, { 'rename', opt('boolean') } }) },
              }),
            },
            returns = success_ret,
          },
        ...
        methods = {
          ...
          },
          {
            ...
            params = {
              ...
              { name = 'offset', type = opt('integer') },
              async_cb({ { 'data', opt('string') } }),
            },
          ...
          },
          {
            ...
            params = {
              { name = 'template', type = 'string' },
              async_cb({ { 'fd', opt('integer') }, { 'path', opt('string') } }),
            },
          ...
          },
          {
            ...
            returns = ret_or_fail('[string, string]', 'name, type'),
          ...
          },
          {
            ...
            params = {
              ...
              async_cb({ { 'permission', opt('boolean') } }),
            },
        ...
        methods = {
          {
            ...
            params = {
              { name = 'host', type = opt('string') },
              { name = 'service', type = opt('string') },
              { name = 'hints', type = opt('getaddrinfo.hints') },
              async_cb({ { 'addresses', opt('addresses') } }),
            },
          ...
          },
          {
            ...
            params = {
              ...
              async_cb({ { 'host', opt('string') }, { 'service', opt('string') } }),
            },
      ...
      },
      {
        ...
        methods = {
          ...
          },
          {
            ...
            params = {
              { name = 'thread', type = 'luv_thread_t' },
              { name = 'mask_size', type = opt('integer') },
            },
            returns = ret_or_fail(dict('integer', 'boolean'), 'affinity'),
          },
          {
      ...
      },
      {
        ...
        methods = {
          ...
          },
          {
            ...
            params = {
              { name = 'name', type = 'string' },
              { name = 'size', type = opt('integer'), default = 'LUA_BUFFERSIZE' },
            },
